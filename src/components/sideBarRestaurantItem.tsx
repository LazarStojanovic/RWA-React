...
class SideBarRestaurantItem extends Component<Props , State> {
  ...
  function mapDispatchToProps(dispatch: Dispatch<Action>) {
    return {
        ...
        clickedItem: (clickedItem:Restaurant) => dispatch(selectedRestaurantItem(clickedItem))
          
    };
  }
  
  export default connect(mapStateToProps,mapDispatchToProps)(SideBarRestaurantItem);